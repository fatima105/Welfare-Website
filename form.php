        ...
        <form class="border-class card p-5" action="javascript:void(0)" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <label for="DistrictArea" class="col-10 offset-1 form-label   mt-2 ">District Area</label>
                ...
                <div class="col-3">
                    ...
                    // // Decode the JSON data
                    $json = json_decode($data, true); ?>
                    <label for="pp" class="col-10 offset-1 form-label   mt-2 ">PP</label>
                ...
                <div class="col-3">
                    ...
                    <label for="UCArea" class="col-10 offset-1 form-label   mt-2 ">UC Area</label>
                ...
                <div class="col-3">
                    ...
                    <label for="UCArea" class="col-10 offset-1 form-label   mt-2 ">Unit </label>
                    <select required name="UCArea" id="UCArea" class="form-control mt-2 col-10 offset-1">
                        <?php
            ...
            <div class="border border-danger mt-2">
                ...
                <input required type="email" class="form-control mt-2 col-9 offset-1" style="border-radius:30px;" required placeholder="Enter email" name="Semail" id="Semail" value="" />
            ...
            <div class="border border-danger mt-2">
                ...
                <label for="name" class="col-9 offset-1 form-label   mt-2 ">Email</label>
                <input required type="email" class="form-control mt-2 col-9 offset-1" style="border-radius:30px;" required placeholder="Enter email" name="Nemail" id="Nemail" value="" />
            ...
            <div class="border border-danger mt-2">
                ...
                <label for="name" class="col-9 offset-1 form-label   mt-2 ">Email</label>
                <input required type="email" class="form-control mt-2 col-9 offset-1" style="border-radius:30px;" required placeholder="Enter email" name="NDemail" id="NDemail" value="" />
